...
# COMMAND ----------
df_filtrado = df_mes.filter(upper(col("nom_subsistema")).contains("NORDESTE"))
...
df_bronze.write.format("delta").mode("append").option("mergeSchema", "true").saveAsTable("clima_energia.bronze.fator_capacidade")
